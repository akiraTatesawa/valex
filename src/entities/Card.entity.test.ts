...
describe("Card Entity", () => {
  ...
  it("Should be able to create a Card Entity with a long cardholder name", () => {
    const cardholderName = randFullName() + randFullName();
    const employeeId = randNumber();
    const type: BusinessType = "education";
  ...
  it("Should be able to create a Card Entity with a long cardholder name and a middle name with less than 3 characters", () => {
    const cardholderName = `${randFullName()} DE ${randFullName()}`;
    const employeeId = randNumber();
    const type: BusinessType = "education";
